...
get_header(); ?>
    ...
    <div class="pravila-igre-wrapper">
        ...
        <!--                <h6>Pravila Igre</h6>-->
        <!--                <div class="paintball-price-about-field-about-logo">-->
        <!--                    <img src="--><?php //echo bloginfo('template_directory');?><!--/assets/images/small-logo.png" alt="">-->
        <!--                </div>-->
        <!--                <h3>Pravila igre - Paintball Sremčica</h3>-->
        <!--            </div>-->
        <!--            <div class="pravila-content object-non-visible wow fadeInLeft animated" data-wow-duration="0.5s" data-wow-delay="400ms">-->
        <!--                <p>Lorem ipsum dolor sit amet, no quo nullam pertinax, te invidunt voluptatibus qui. Nec ne solum convenire iudicabit, an pro aliquam veritus. Qui ne labore tractatos instructior, an offendit tractatos vix. Debet ocurreret est ei. Soluta deserunt ut cum, ne nec summo harum ceteros. Modus luptatum adipiscing an duo.</p>-->
        <!--                <p>Cu tation essent iisque usu, utinam suavitate pri in, sed timeam temporibus in. Eam vide illum ignota et, albucius urbanitas elaboraret eu quo. Vim in odio meis. Qui graeci maluisset ea, nostro appellantur nam te. Facer quodsi dolorem vim eu. Legimus utroque fastidii vix an, usu ei mutat.</p>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--        <div class="pravila-right object-non-visible wow fadeInRight animated" data-wow-duration="0.5s" data-wow-delay="400ms">-->
        <!--            <img src="--><?php //echo bloginfo('template_directory');?><!--/assets/images/pravila.jpg" alt="">-->
